...
class Base extends Component
{
    ...
    public function render($component = false)
    {
        ...
        if (!view()->exists('form::' . $this->framework . '.' . $blade)) {
            $blade = 'text';
        }

        if ($component) {
            return view('form::' . $this->framework . '.' . $blade, get_object_vars($this));
        }

        return view('form::' . $this->framework . '.' . $blade);
    }
